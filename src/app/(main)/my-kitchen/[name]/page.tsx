    ...
    return (<div>
        ...
        <div className="lg:max-w-[90rem] md:max-w-[87.5rem] max-w-[85rem] h-full mx-auto lg:px-[3.75rem] md:px-10 px-5">
            ...
            <div className="flex justify-end mt-8 gap-3">
                <Button type="button" label="Back" className="text-gray-900 rounded-full bg-gray-50 px-8 py-[0.875rem] hover:opacity-60 focus:shadow-none" onClick={() => router.back()} />
                <Button type="button" label="Submit" disabled={!name || !qty || !unit} className="text-white rounded-full bg-success px-8 py-[0.875rem] hover:opacity-60 focus:shadow-none" onClick={handleSubmit} />
            </div>
        </div>
    </div>)
}
