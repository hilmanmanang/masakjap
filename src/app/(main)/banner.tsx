            ...
            <div className="lg:max-w-[90rem] md:max-w-[87.5rem] max-w-[85rem] h-full mx-auto lg:px-[3.75rem] md:px-10 px-5 flex items-center gap-10">
                ...
                <div>
                    ...
                    <ScrollReveal delay="0.15s">
                        <div className="max-w-[40rem] text-gray-900 font-semibold text-7xl mb-4 leading-tight">Find Recipes from Your Fridge </div>
                    </ScrollReveal>
                    <ScrollReveal delay="0.45s">
                        <div className="text-gray-500 text-sm font-normal mb-8">You have a lot ingredients in your fridge but don&apos;t know what to cook?</div>
                    </ScrollReveal>
